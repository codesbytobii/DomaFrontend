...
// Mirrors SubscriptionPlanController::MODULES on the backend — the set of
// module slugs a subscription plan can grant.
// Mirrors SubscriptionPlan::CYCLE_MONTHS on the backend.
export const BILLING_CYCLES = {
  monthly: { label: "Monthly", months: 1, unit: "month" },
  quarterly: { label: "Quarterly", months: 3, unit: "quarter" },
  biannual: { label: "Bi-annual (every 6 months)", months: 6, unit: "6-month term" },
  annual: { label: "Annual", months: 12, unit: "year" },
};
